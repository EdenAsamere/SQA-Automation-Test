...
- Name: verify navigation menu structure exists
- Location: C:\Users\Hp\Desktop\sqa\SQA-Automation-Test\tests\admin-navigation.spec.js:61:1

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('a[href="/equbs"]') resolved to 2 elements:
    1) <a href="/equbs" class="flex flex-row space-x-4 items-center p-2 rounded-lg hover:bg-gray-700 text-gray-400">…</a> aka getByRole('link', { name: 'equbs' })
    2) <a href="/equbs" class="flex w-full text-2xl ">equbs</a> aka getByRole('main').getByText('equbs')

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('a[href="/equbs"]')

    at C:\Users\Hp\Desktop\sqa\SQA-Automation-Test\tests\admin-navigation.spec.js:68:27
```
